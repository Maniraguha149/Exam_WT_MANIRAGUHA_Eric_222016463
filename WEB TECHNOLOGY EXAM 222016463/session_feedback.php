...
<section>
  ...
  <form method="post" onsubmit="return confirmInsert();">
    ...
    <input type="number" id="feedback_text" name="feedback_text" required><br><br>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $cvp = $connection->prepare("INSERT INTO session_feedback(session_id, attendee_id, feedback_text,rating) VALUES (?, ?, ?,?)");
  ...
  <h2>Table of session_feedback</h2>
  <table border="1">
    <tr>
      <th>session_id</th>
      <th>attendee_id</th>
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<tr>
                    ...
                    <td>" . $row['rating'] . "</td>
                    <td><a style='padding:4px' href='delete_session_attendees.php?session_id=$session_id'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_session_attendees.php?session_id=$session_id'>Update</a></td> 
                </tr>";
        }
    } else {
